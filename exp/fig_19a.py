#
# Fig.19a: Sensitivity: span size => cache efficiency/load factor
#
...
def main(cmd: CMDManager, tp: LogParser):
    plot_data = {
        ...
        'X_data': span_sizes,
        'Y_data': {'Cache Efficiency': [], 'Load Factor': [], 'Throughput': []}
    }
    ...
    for span_size in span_sizes:
        ...
        plot_data['Y_data']['Cache Efficiency'].append(consumed_cache_size)
        plot_data['Y_data']['Load Factor'].append(load_factor)
