#
# Fig.4b: Expensive B+ Tree's metadata access
#
...
segment_size              = exp_params['segment_size']  # neighborhood size
test_type_idx = {
    'Segment': 2,
    'Segment with Metadata': 3,
    'Segment and Metadata (2-I/O)': 4,
...
def main(cmd: CMDManager, tp: LogParser):
    ...
    for method in methods:
        ...
        for key_size in key_sizes:
            ...
            metadata_len = 8 + 2 * key_size  # sibling pointer and fence keys
            RDMA_TEST = f"{env_cmd} && ./zipf_rdma_test {CN_num} {client_num_per_CN} 2 {key_size} {value_size} {span_size} {segment_size} {metadata_len} {test_type_idx[method]}"
            print(RDMA_TEST)
            ...
            plot_data['X_data'][method].append(key_size)
